...
if (!is_null($listing->lat) && !is_null($listing->lng)) : ?>
    ...
    <?php if ($showBrokerImage) : ?>
        ...
        <img src="<?php echo $listing->branding->brokerLogo; ?>" style="max-height:50px;width:auto" alt="Broker Reciprocity">
        </div>
    <?php endif; ?>
    </td>
    ...
    <div style="text-align:left;padding-top:20px;"><?php echo $listing->branding->content; ?>
    </div>
    </div>
    </td>
    </tr>
