	...
	var methods = {
		...
		public: {
			...
			init: function(options) {
				...
				if (!options.suggestionUrl) {
					$.error('The "suggestionUrl" option must be included when initializing the plugin.');
					return this;
				}
