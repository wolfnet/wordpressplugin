...
implements com_ajmichels_wppf_interface_iView
{
	...
	public function render ( $data = array() )
	{
		$data = array_merge( $data, array( 
			...
			'autoDirectionUp'    => selected( $data['fields']['direction']['value'], 'up', false ),
			'autoDirectionDown'  => selected( $data['fields']['direction']['value'], 'down', false ),
			'manDirectionVert'   => ( $data['fields']['direction']['value'] == 'right' || $data['fields']['direction']['value'] == 'left' ) ? ' selected="selected"' : '' ,
			'manDirectionHorz'   => ( $data['fields']['direction']['value'] == 'up'    || $data['fields']['direction']['value'] == 'down' ) ? ' selected="selected"' : '' ,
			'waitId'             => esc_attr( $data['fields']['wait']['id'] ),
			'waitName'           => esc_attr( $data['fields']['wait']['name'] ),
			'waitChecked'        => checked(  $data['fields']['wait']['value'], 'true', false ),
