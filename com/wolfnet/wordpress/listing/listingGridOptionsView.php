...
implements com_greentiedev_wppf_interface_iView
{
	...
	public function render ( $data = array() )
	{
		$data = array_merge( $data, array(
			...
			'usesPaginationId'	    => esc_attr( $data['fields']['usesPagination']['id'] ),
			'usesPaginationName'	=> esc_attr( $data['fields']['usesPagination']['name'] ),
			'usesPaginationTrue'	=> selected( $data['fields']['usesPagination']['value'], 'true', false ),
			'usesPaginationFalse'	=> selected( $data['fields']['usesPagination']['value'], 'false', false ),
