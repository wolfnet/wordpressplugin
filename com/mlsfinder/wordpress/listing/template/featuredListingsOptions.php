...
<div class="mlsFinder_featuredListingsOptions">
	...
	<p>
		...
		<select id="<?php echo $autoPlayId; ?>" name="<?php echo $autoPlayName; ?>" 
			class="mlsFinder_featuredListingsOptions_autoPlayField">
	...
	<fieldset class="mlsFinder_featuredListingsOptions_autoPlayOptions">
		
		<p>
			<label>Direction:</label>
			<select id="<?php echo $directionId; ?>" name="<?php echo $directionName; ?>" 
				class="mlsFinder_featuredListingsOptions_autoDirField">
	...
	<fieldset class="mlsFinder_featuredListingsOptions_manualPlayOptions">
		
		<p>
			<label>Direction:</label>
			<select id="<?php echo $directionId; ?>" name="<?php echo $directionName; ?>" 
				class="mlsFinder_featuredListingsOptions_manDirField">
