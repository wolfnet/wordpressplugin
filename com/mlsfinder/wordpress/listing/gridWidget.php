...
/**
 * This is the gridWidget object. This object inherites from the base WP_Widget object and 
...
class com_mlsfinder_wordpress_listing_gridWidget
extends com_mlsfinder_wordpress_abstract_widget
{
	...
	{
		parent::__construct( 'mlsFinder_gridWidget', 'MLS Finder Listing Grid' );
	}
	...
	public function form ( $instance )
	{
		...
		$this->getGridOptionsView()->out( $data );
	}
	...
	{
		return $this->sf->getBean( 'GridView' );
	}
	
	
	public function getGridOptionsView ()
	{
		return $this->sf->getBean( 'GridOptionsView' );
	}
