...
class com_mlsfinder_wordpress_listing_gridOptionsView
extends com_ajmichels_wppf_abstract_view
implements com_ajmichels_wppf_interface_iView
{
	...
	{
		$this->log( 'Init com_mlsfinder_wordpress_listing_gridOptionsView' );
		$this->template = $this->formatPath( dirname( __FILE__ ) . '\template\gridOptions.php' );
	}
